                                                    ...
                                                    <div class="add-property-inner-box bg-white theme-border radius-4 p-20 pb-0 mb-25"
                                                        ...
                                                        <div class="tenants-inner-box-block">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 col-lg-4 mb-25">
                                                                    <label class="label-text-title color-heading font-medium mb-2">{{ __('Reminder message') }}</label>
                                                                    <input type="text" id="reminder_message" class="form-control" autocomplete="off"
                                                                           placeholder="{{ __('Reminder message') }}" name="reminder_message" value="pay monthly rent">
                                                                </div>
                                                            </div>
